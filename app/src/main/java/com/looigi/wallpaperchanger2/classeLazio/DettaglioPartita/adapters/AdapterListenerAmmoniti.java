...
public class AdapterListenerAmmoniti extends BaseAdapter {
    private Context context;
    private List<Ammoniti> lista;
    private LayoutInflater inflter;
    private boolean inCasa;

    public AdapterListenerAmmoniti(Context applicationContext, List<Ammoniti> Lista, boolean Casa) {
