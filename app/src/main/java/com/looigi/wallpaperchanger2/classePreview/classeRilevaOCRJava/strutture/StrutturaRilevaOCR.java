package com.looigi.wallpaperchanger2.classePreview.classeRilevaOCRJava.strutture;

public class StrutturaRilevaOCR {
    ...
    public String getQuante() {
        return Quante;
    }

    public void setQuante(String quante) {
        Quante = quante;
    }
