...
import com.looigi.wallpaperchanger2.classePennetta.webservice.TaskDelegate;
...
public class InterrogazioneWSSP {
    ...
    private TaskDelegateSP delegate;
    ...
    private void Esecuzione() {
        /* if (!VariabiliStaticheWallpaper.getInstance().isRetePresente()) {
            UtilityPennetta.getInstance().ScriveLog(context, NomeMaschera, "Operazione di rete " + tOperazione + " non possibile: Rete non presente");
            Errore = true;
