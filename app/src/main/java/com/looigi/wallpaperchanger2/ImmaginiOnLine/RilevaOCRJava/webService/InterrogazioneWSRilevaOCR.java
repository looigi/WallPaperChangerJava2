...
public class InterrogazioneWSRilevaOCR {
    private boolean isCancelled;
    private static final String NomeMaschera = "Lettura_WS_RILEVA_OCR";
    ...
    private TaskDelegateRilevaOCR delegate;
    ...
    public void EsegueChiamata(Context context, String NAMESPACE, int TimeOut,
                               ...
                               TaskDelegateRilevaOCR delegate) {
        isCancelled = false;
