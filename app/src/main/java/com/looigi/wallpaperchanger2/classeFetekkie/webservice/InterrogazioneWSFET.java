...
import com.looigi.wallpaperchanger2.classeFetekkie.webservice.TaskDelegate;
...
public class InterrogazioneWSFET {
    private boolean isCancelled;
    private static final String NomeMaschera = "Lettura_WS_Immagini_PEN";
    ...
    public void EsegueChiamata(Context context, String NAMESPACE, int TimeOut,
        ...
        // UtilityFetekkie.getInstance().ApriDialog(ApriDialog, this.tOperazione);
    ...
    private void Esecuzione() {
        /* if (!VariabiliStaticheWallpaper.getInstance().isRetePresente()) {
            UtilityFetekkie.getInstance().ScriveLog(context, NomeMaschera, "Operazione di rete " + tOperazione + " non possibile: Rete non presente");
            Errore = true;
            ...
            if (Parametri != null) {
                for (int i = 0; i < Parametri.length; i++) {
                    if (Parametri[i] != null) {
                        ...
                        UtilityFetekkie.getInstance().ScriveLog(context, NomeMaschera, "Parametro " + Parametro + ": " + Valore);
                    }
                }
            }
            ...
            UtilityFetekkie.getInstance().ScriveLog(context, NomeMaschera, "Urletto: " + Urletto);
            ...
            try {
                ...
                if (tOperazione.equals("RitornaFiles")) {
                    ...
                    UtilityFetekkie.getInstance().ScriveLog(context, NomeMaschera, "Errore di socket su ws per operazione " + tOperazione + ": " + messErrore);
                }
            } catch (IOException e) {
                Errore = true;
                messErrore = UtilityDetector.getInstance().PrendeErroreDaException(e);
                ...
                UtilityFetekkie.getInstance().ScriveLog(context, NomeMaschera, "Errore di I/O su ws per operazione " + tOperazione + ": " + messErrore);
                ...
                UtilityFetekkie.getInstance().ScriveLog(context, NomeMaschera, "Errore di parsing su ws per operazione " + tOperazione + ": " + messErrore);
            } catch (Exception e) {
                Errore = true;
                messErrore = UtilityDetector.getInstance().PrendeErroreDaException(e);
                if (messErrore != null)
                ...
                UtilityFetekkie.getInstance().ScriveLog(context, NomeMaschera, "Errore generico su ws per operazione " + tOperazione + ": " + messErrore);
            }
            if (!Errore && !isCancelled) {
                try {
                    result = "" + soapEnvelope.getResponse();

                    UtilityFetekkie.getInstance().ScriveLog(context, NomeMaschera, "Lettura ok su ws per operazione " + tOperazione);
                } catch (SoapFault e) {
                    Errore = true;
                    messErrore = UtilityDetector.getInstance().PrendeErroreDaException(e);
                    if (messErrore != null) {
                    ...
                    UtilityFetekkie.getInstance().ScriveLog(context, NomeMaschera, "Errore SoapFault su ws per operazione " + tOperazione + ": " + messErrore);
                }
            } else {
                int a = 0;
            }
            ...
            if (isCancelled) {
                ...
                UtilityFetekkie.getInstance().ScriveLog(context, NomeMaschera, "Richiesta uscita da ws su operazione " + tOperazione + ": " + messErrore);
            }
        // }
    }

    private void TermineEsecuzione() {
        // UtilityFetekkie.getInstance().ChiudeDialog();
        ...
        if (!messErrore.equals("ESCI")) {
            ...
            if (Ritorno.contains("ERROR:")) {
                ...
                // if (VariabiliStaticheWallpaper.getInstance().isRetePresente()) {
                    ...
                    UtilityFetekkie.getInstance().ScriveLog(context, NomeMaschera, "ERRORE Su Lettura Asincrona: " + messErrore);
                ...
                UtilityFetekkie.getInstance().ScriveLog(context, NomeMaschera, "Avviso per termine chiamata su operazione " + tOperazione);
            ...
            UtilityFetekkie.getInstance().ScriveLog(context, NomeMaschera, "Uscita da ws su operazione " + tOperazione);
