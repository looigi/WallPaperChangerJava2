...
public class InterrogazioneWSF {
    private boolean isCancelled;
    private static final String NomeMaschera = "Lettura_WS_Films";
    ...
    private void Esecuzione() {
        if (!VariabiliStaticheWallpaper.getInstance().isRetePresente()) {
            UtilityFilms.getInstance().ScriveLog(context, NomeMaschera, "Operazione di rete " + tOperazione + " non possibile: Rete non presente");
            Errore = true;
            ...
            if (Parametri != null) {
                for (int i = 0; i < Parametri.length; i++) {
                    if (Parametri[i] != null) {
                        ...
                        UtilityFilms.getInstance().ScriveLog(context, NomeMaschera, "Parametro " + Parametro + ": " + Valore);
                    }
                }
            }
            ...
            UtilityFilms.getInstance().ScriveLog(context, NomeMaschera, "Urletto: " + Urletto);
            ...
            try {
                ...
                if (tOperazione.equals("RitornaFiles")) {
                    ...
                    UtilityFilms.getInstance().ScriveLog(context, NomeMaschera, "Errore di socket su ws per operazione " + tOperazione + ": " + messErrore);
                }
            } catch (IOException e) {
                Errore = true;
                messErrore = UtilityWallpaper.getInstance().PrendeErroreDaException(e);
                ...
                UtilityFilms.getInstance().ScriveLog(context, NomeMaschera, "Errore di I/O su ws per operazione " + tOperazione + ": " + messErrore);
                ...
                UtilityFilms.getInstance().ScriveLog(context, NomeMaschera, "Errore di parsing su ws per operazione " + tOperazione + ": " + messErrore);
            } catch (Exception e) {
                Errore = true;
                messErrore = UtilityWallpaper.getInstance().PrendeErroreDaException(e);
                if (messErrore != null)
                ...
                UtilityFilms.getInstance().ScriveLog(context, NomeMaschera, "Errore generico su ws per operazione " + tOperazione + ": " + messErrore);
            }
            if (!Errore && !isCancelled) {
                try {
                    result = "" + soapEnvelope.getResponse();

                    UtilityFilms.getInstance().ScriveLog(context, NomeMaschera, "Lettura ok su ws per operazione " + tOperazione);
                } catch (SoapFault e) {
                    Errore = true;
                    messErrore = UtilityWallpaper.getInstance().PrendeErroreDaException(e);
                    if (messErrore != null) {
                    ...
                    UtilityFilms.getInstance().ScriveLog(context, NomeMaschera, "Errore SoapFault su ws per operazione " + tOperazione + ": " + messErrore);
                }
            } else {
                int a = 0;
            }
            ...
            if (isCancelled) {
                ...
                UtilityFilms.getInstance().ScriveLog(context, NomeMaschera, "Richiesta uscita da ws su operazione " + tOperazione + ": " + messErrore);
            }
        }
    }
    ...
    private void TermineEsecuzione() {
        ...
        if (!messErrore.equals("ESCI")) {
            ...
            if (Ritorno.contains("ERROR:")) {
                ...
                if (VariabiliStaticheWallpaper.getInstance().isRetePresente()) {
                    // OggettiAFilms.getInstance().getImgIndietro().setVisibility(LinearLayout.VISIBLE);
                    // OggettiAFilms.getInstance().getImgAvanti().setVisibility(LinearLayout.VISIBLE);
                    // OggettiAFilms.getInstance().getImgPlay().setVisibility(LinearLayout.VISIBLE);

                    UtilityFilms.getInstance().ScriveLog(context, NomeMaschera, "ERRORE Su Lettura Asincrona: " + messErrore);
                ...
                UtilityFilms.getInstance().ScriveLog(context, NomeMaschera, "Avviso per termine chiamata su operazione " + tOperazione);
            ...
            UtilityFilms.getInstance().ScriveLog(context, NomeMaschera, "Uscita da ws su operazione " + tOperazione);
