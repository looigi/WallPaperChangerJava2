...
public class InterrogazioneWSLazio {
    private boolean isCancelled;
    private static final String NomeMaschera = "Lettura_WS_LAZIO";
    ...
    private TaskDelegateLazio delegate;
