...
public class InterrogazioneWSModifiche {
    private boolean isCancelled;
    private static final String NomeMaschera = "Lettura_WS_MODIFICHE";
    ...
    private TaskDelegateModifiche delegate;
    ...
    public void EsegueChiamata(Context context, String NAMESPACE, int TimeOut,
                               ...
                               TaskDelegateModifiche delegate) {
        isCancelled = false;
