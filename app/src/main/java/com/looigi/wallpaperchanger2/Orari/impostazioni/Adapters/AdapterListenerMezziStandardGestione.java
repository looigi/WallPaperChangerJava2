...
public class AdapterListenerMezziStandardGestione extends BaseAdapter {
    private Context context;
    private List<StrutturaMezzi> listaMezzi;
    private List<StrutturaMezzi> listaMezziOrig;
    private LayoutInflater inflter;

    public AdapterListenerMezziStandardGestione(Context applicationContext, List<StrutturaMezzi> Mezzi) {
