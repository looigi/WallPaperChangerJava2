...
import com.looigi.wallpaperchanger2.Pazzia.GestioneCategorie.GestioneCategorie;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        spnCategorieUnite.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view,
                ...
                for (com.looigi.wallpaperchanger2.ImmaginiOnLine.Immagini.strutture.StrutturaImmaginiCategorie c1:
        ...
        imgSettingsIMM.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                int c = 0;
                for (com.looigi.wallpaperchanger2.ImmaginiOnLine.Immagini.strutture.StrutturaImmaginiCategorie s : VariabiliStatichePazzia.getInstance().getListaCategorieIMM()) {
                    l2[c] = s.getCategoria();
                    c++;
                }
